    ...
    return (
        <>
            ...
            <motion.div
                ...
                draggable
                tabIndex={0}
                className={cn("my-1 w-full bg-neutral-300 dark:bg-neutral-500 flex flex-col clear-both overflow-visible p-2 hover:shadow-2xl rounded ring-amber-300", props.id == selected? "ring-4": "")}
            >
