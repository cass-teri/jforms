    ...
    return (
        <>
            ...
            <motion.div
                ...
                tabIndex={0}
                className={cn(
                    "my-1 w-full bg-neutral-200 text-neutral-800 flex flex-col clear-both overflow-visible  p-2 hover:shadow-2xl rounded ring-amber-300",
                ...
                <div className="overflow-visible clear-both">
                    <div className="clear-both">
                        {children?.map((ast, index) => {
                            return GetComponentForComponentType(ast.type, { ast, id: ast.id, key: index })
                        })}
                    </div>
