    ...
    return (
        <>
            ...
            <motion.div
                ...
                onClick={OnClick}
                tabIndex={0}
                className={cn("w-full bg-neutral-300 dark:bg-neutral-500 flex flex-col clear-both overflow-visible  p-2 hover:shadow-2xl rounded focus:ring-4 ring-amber-300", props.id == selected? "ring-4": "")}
            >
