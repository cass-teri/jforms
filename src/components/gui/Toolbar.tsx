...
import { MdHelpCenter, MdOutlineAlternateEmail, MdOutlineLandscape } from "react-icons/md"
...
export function Toolbar() {
    ...
    return (
        <>
            <aside className="bg-neutral-700 fixed left-0 top-0 bottom-0 w-28 justify-start items-center pt-4 overflow-auto">
                ...
                */}
                ...
                <div className="grid grid-cols-2 grid-flow-dense gap-1">
                    ...
                    <button
                        ...
                        title="HelpContent"
                    >
                        <MdHelpCenter className={icon_style} />
                    </button>
